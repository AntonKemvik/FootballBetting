...
public class AllPlayers {
	...
	public boolean writeToFile() {
		try {
			File file = new File("C:\\Users\\Stoffe\\Desktop\\Textfiles\\AllPlayers.txt");
	...
	public boolean readFromFile() {
		try {
			BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Stoffe\\Desktop\\Textfiles\\AllPlayers.txt"));
			String line;
